"""
Script to render docs/MediAssist_Technical_Masterclass.md into a high-quality PDF
using Headless Chrome with executive-grade typography, responsive images,
and print-optimized CSS pagination.
"""
...
PDF_PATH = os.path.join(DOCS_DIR, "MediAssist_Technical_Masterclass.pdf")
TEMP_HTML = os.path.join(DOCS_DIR, "temp_masterclass_render.html")
...
def build_pdf():
    ...
    @page :left {
        @bottom-left { content: "MediAssist Technical Masterclass"; font-size: 8pt; color: #64748b; font-family: sans-serif; }
        @bottom-right { content: counter(page); font-size: 8pt; color: #64748b; font-family: sans-serif; }
    }
    @page :right {
        @bottom-left { content: "Staff AI Engineering Architecture"; font-size: 8pt; color: #64748b; font-family: sans-serif; }
        @bottom-right { content: counter(page); font-size: 8pt; color: #64748b; font-family: sans-serif; }
    }
...
<head>
<meta charset="utf-8">
<title>MediAssist Technical Masterclass</title>
<style>
{css}
</style>
</head>
...
{html_with_images}
    ...
    if os.path.exists(PDF_PATH):
        ...
        print(f"Success! Masterclass PDF compiled: {PDF_PATH} ({size_kb:.1f} KB)")
    else:
